...
<body class="bg-gray-100">
    <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">Add to Watchlist</h1>
        @if ($errors->any())
        ...
        @endif
        <form method="POST" action="{{ route('watchlists.store') }}" class="bg-white p-6 rounded shadow">
            @csrf
            <div class="mb-4">
        ...
        <a href="{{ route('watchlists.index') }}" class="text-blue-500 mt-4 inline-block">Back</a>
    </div>
</body>
</html>